...
qualifier) appear in \S\ref{sec:limitations}. We keep the
inference rules in paper form here so the operational reading is
visible; the Lean 4 artefact in \S\ref{subsec:soundness-mech}
mechanises the soundness correspondence over this fragment.
