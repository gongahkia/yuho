...
contracts and regulations (lam4~\cite{lam4}), structured contract
compilation (LexScript~\cite{lexscript}), plain-text DOCX authoring
(LDOC~\cite{ldoc}) ---
...
natively model). It is a claim that the gap between a drafted
