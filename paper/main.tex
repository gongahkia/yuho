...
\IfFileExists{methodology/methodology.tex}{\input{methodology/methodology}}{%
  ...
  \providecommand{\statBenchmarkLlmTone}{43.9}%
  \providecommand{\statBenchmarkLlmTtwo}{32.7}%
  \providecommand{\statBenchmarkLlmTtwoFOne}{0.676}%
  \providecommand{\statBenchmarkLlmTthree}{94.1}%
  \providecommand{\statBenchmarkLlmNegPolarTone}{33.3}%
  \providecommand{\statBenchmarkLlmNegPolarFOne}{0.056}%
