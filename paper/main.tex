...
tree-sitter parser, a Python AST, seven transpilers (JSON, controlled English,
\LaTeX{}, Mermaid, Alloy, DOCX, Akoma Ntoso), a Language Server, a Model Context Protocol
