...
def test_backend_parity_summary_lists_evidence_and_boundaries() -> None:
    ...
    assert "case_law_doctrine: runtime=active-effects/positive-treatment-adoption/ordered-cumulative/negative-treatment-nonadoption/own-effect/missing-target/target-remap/payload-preserve/cycle-cutoff/inactive-authority/jurisdiction-burden-shift-precedence-partial; z3=unsupported; lean=typed-fact-burden+surface-alias+surface-precedence-rank+cumulative-effect+ordered-cumulative+negative-treatment-nonadoption+own-effect+missing-target+target-remap+payload-preserve+adoption-cycle+effect-adoption-metadata-inactive-authority-jurisdiction-burden-precedence-rank-conflict-partial" in summary
