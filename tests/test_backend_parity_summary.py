...
def test_backend_parity_summary_lists_evidence_and_boundaries() -> None:
    ...
    assert "case_law_doctrine: runtime=active-effects/positive-treatment-adoption/cycle-cutoff/burden-shift-precedence-partial; z3=unsupported; lean=typed-fact-burden+surface-alias+surface-precedence-rank+cumulative-effect+adoption-cycle+effect-adoption-metadata-inactivation-burden-precedence-rank-conflict-partial" in summary
