...
This is a generated corpus audit, not a Core Yuho v0.3 language version. Core semantics remain v0.2. The canonical inputs are the {coverage['summary']['provisions']} rows in [`../../research/singapore/SINGAPORE-CRIMINAL-LAW-COVERAGE-v0.3.json`](../../research/singapore/SINGAPORE-CRIMINAL-LAW-COVERAGE-v0.3.json).
