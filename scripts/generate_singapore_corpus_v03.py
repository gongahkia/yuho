...
def render_gaps(coverage: dict) -> str:
    ...
    return f"""# Deferred research and tooling

This is the current corpus gap audit for Yuho v1. The canonical inputs are the {coverage['summary']['provisions']} rows in [`../research/singapore/SINGAPORE-CRIMINAL-LAW-COVERAGE-v0.3.json`](../research/singapore/SINGAPORE-CRIMINAL-LAW-COVERAGE-v0.3.json). Normative positions, richer candidate sanctions and explicit responsibility routes close representation gaps only where saved material supports a responsible authored model.
