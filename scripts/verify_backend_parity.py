...
FEATURE_COVERAGE = (
    ...
    (
        "case_law_doctrine",
        "runtime=active-effects/positive-treatment-adoption/burden-shift-partial; z3=unsupported; lean=effect-adoption-inactivation-burden-partial; alloy=unsupported",
    ),
)
