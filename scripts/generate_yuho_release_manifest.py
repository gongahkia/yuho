...
EXACT = [
    ...
    "docs/rewrite/core-yuho-conformance-v0.1.json",
    "docs/rewrite/core-yuho-conformance-v0.2.json",
    "docs/rewrite/core-yuho-conformance-v0.3.json",
    ...
    "rewrite/frontend/fixtures/synthetic/request.json",
    "rewrite/frontend/fixtures/synthetic/response.json",
    "rewrite/frontend/fixtures/temporal/pre-request.json",
    "rewrite/frontend/fixtures/temporal/pre-response.json",
    "rewrite/frontend/fixtures/temporal/post-request.json",
    "rewrite/frontend/fixtures/temporal/post-response.json",
    "rewrite/frontend/fixtures/typed-finite-v0.3/normative-responsibility.yh",
    "rewrite/frontend/fixtures/typed-finite-v0.3/normative-responsibility-satisfied.yh",
    "rewrite/frontend/fixtures/typed-finite-v0.3/modular-normative-responsibility.yh",
    "rewrite/frontend/fixtures/typed-finite-v0.3/modular-normative-responsibility-satisfied.yh",
    "rewrite/frontend/fixtures/typed-finite-v0.3/modules/fictional.normative-routes@1.0.0.yh",
    "rewrite/frontend/fixtures/synthetic/rich-candidate-sanctions.yh",
    "rewrite/frontend/fixtures/synthetic/scenario-rich-candidate-sanctions.yh",
    "rewrite/haskell/schema/request.schema.json",
    "rewrite/haskell/schema/result.schema.json",
    "rewrite/haskell/schema/typed-finite-rules-request.schema.json",
    "rewrite/haskell/schema/typed-finite-rules-result.schema.json",
]
GLOBS = [
    "docs/rewrite/release-v1-artifacts/*.json",
    "docs/rewrite/diagram-fixtures/*.json",
    "docs/rewrite/diagram-fixtures/*.svg",
    "docs/rewrite/typed-finite-diagram-fixtures/*.json",
    "docs/rewrite/typed-finite-diagram-fixtures/*.svg",
    "docs/rewrite/release-v1-diagram-fixtures/*.json",
    "docs/rewrite/release-v1-diagram-fixtures/*.svg",
]
