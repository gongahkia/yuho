...
FEATURE_COVERAGE = (
    ...
    ("case_law_doctrine", "Yuho/CaseLaw.lean surface-alias + effect + transitive adoption/metadata + inactive-treatment + burden-metadata + precedence-rank/conflict lemmas", "partial"),
