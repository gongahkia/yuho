...
FEATURE_COVERAGE = (
    ...
    ("case_law_doctrine", "Yuho/CaseLaw.lean surface-alias + surface-precedence-rank + effect + cumulative-effect + own-effect + missing-target + transitive/cyclic adoption + metadata + inactive-treatment + jurisdiction-burden-metadata + precedence-rank/conflict lemmas", "partial"),
