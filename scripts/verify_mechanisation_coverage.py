...
FEATURE_COVERAGE = (
    ...
    ("case_law_doctrine", "Yuho/CaseLaw.lean surface-alias + surface-precedence-rank + effect + cumulative-effect + ordered-cumulative + negative-treatment-nonadoption + own-effect + missing-target + target-remap + payload-preserve + transitive/cyclic adoption + metadata + inactive-authority + jurisdiction-burden-metadata + precedence-rank/conflict lemmas", "partial"),
