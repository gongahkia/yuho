...
def run_api(
    ...
    click.echo(f"Workspaces: {'enabled' if ws_router else 'disabled'}")
    ...
    click.echo("  POST /v1/jobs/submit   - Submit async job")
    click.echo("  GET  /v1/jobs/{id}     - Job status")
    click.echo("  GET  /v1/jobs/{id}/stream - SSE job events")
