...
BACKEND_METADATA: Dict[str, Dict[str, Any]] = {
    ...
    "lean": {
        ...
        "unsupported_features": [
            ...
            "full case-law semantics beyond typed-fact/surface-alias/surface-precedence-rank/effect/adoption-metadata/inactivation/burden-metadata/precedence-rank/conflict fragment",
