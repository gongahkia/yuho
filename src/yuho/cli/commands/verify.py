...
BACKEND_METADATA: Dict[str, Dict[str, Any]] = {
    ...
    "lean": {
        ...
        "unsupported_features": [
            ...
            "full case-law semantics beyond typed-fact/surface-alias/surface-precedence-rank/fact-key/same-kind-nonconflict/effect/cumulative-effect/ordered-cumulative/negative-treatment-nonadoption/own-effect/missing-target/target-remap/payload-preserve/adoption-cycle/adoption-metadata/inactive-authority/jurisdiction-burden-metadata/precedence-rank/conflict fragment",
