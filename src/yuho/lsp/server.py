...
class YuhoLanguageServer(LanguageServer):
    ...
    def _get_semantic_tokens(self, uri: str) -> Optional[lsp.SemanticTokens]:
        ...
        SOURCE_PATTERNS = [
            ...
            (r"\bsource\b",           TOKEN_TYPES["keyword"],       0),
            (r"\bsource_bundle\b",    TOKEN_TYPES["keyword"],       0),
            (r"\blocator\b",          TOKEN_TYPES["keyword"],       0),
            (r"\btimeline\b",         TOKEN_TYPES["keyword"],       0),
            (r"\bentity\b",           TOKEN_TYPES["keyword"],       0),
            (r"\breltype\b",          TOKEN_TYPES["keyword"],       0),
            (r"\brel\b",              TOKEN_TYPES["keyword"],       0),
            (r"\bruleset\b",          TOKEN_TYPES["keyword"],       0),
            (r"\bdeadline_rule\b",    TOKEN_TYPES["keyword"],       0),
            (r"\bissue\b",            TOKEN_TYPES["keyword"],       0),
            (r"\bissue_element\b",    TOKEN_TYPES["keyword"],       0),
            (r"\bscenario\b",         TOKEN_TYPES["keyword"],       0),
            (r"\bview\b",             TOKEN_TYPES["keyword"],       0),
            (r"\bconstraint\b",       TOKEN_TYPES["keyword"],       0),
