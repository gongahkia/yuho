...
class JSONLDTranspiler(TranspilerBase):
    ...
    def _map_type(self, node_type: str) -> str:
        ...
        type_mapping = {
            ...
            "MatchArm": "yuho:DecisionBranch",
            "ElementNode": "yuho:LegalElement",
            "ElementGroupNode": "yuho:ElementGroup",
            "ExceptionNode": "yuho:LegalException",
            "CaseLawNode": "yuho:CaseLaw",
            "PenaltyNode": "yuho:Penalty",
            "DurationNode": "Duration",
            "MoneyNode": "MonetaryAmount",
            "StringLit": "Text",
    ...
    def _map_property(self, prop: str) -> str:
        ...
        prop_mapping = {
            ...
            "caning_min": "yuho:minCaning",
            "caning_max": "yuho:maxCaning",
            "death_penalty": "yuho:deathPenalty",
            "combinator": "yuho:combinator",
            "members": "yuho:hasMembers",
            "condition": "yuho:condition",
            "effect": "yuho:effect",
            "case_name": "yuho:caseName",
            "citation": "yuho:citation",
            "holding": "yuho:holding",
            "element_ref": "yuho:elementReference",
            "exceptions": "yuho:hasException",
            "case_law": "yuho:hasCaseLaw",
            "supplementary": "yuho:supplementaryPunishment",
