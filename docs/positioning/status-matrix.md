...
| Lean | stable-bounded | `make verify-mechanisation`, `make verify-core-yuho-conformance` | Core Yuho v0.1 and the additive v0.2 typed finite operations have machine-checked semantics and bounded independent conformance. This is not an end-to-end compiler, corpus or legal-correctness proof. The older Python/Z3 structural mechanisation remains a separate historical boundary. |
