...
There are no modules, imports, macros, general negation, arbitrary expressions, evidence assessment, dynamic burdens, real-jurisdiction selection, temporal applicability, sentencing, court outcomes or arbitrary multi-rule composition. The frontend and kernel produce technical rule results and traces only; they provide no legal advice or judicial disposition. A future version needs an explicit composition, module and migration design before claiming a broader language core.
