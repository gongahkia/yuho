...
4. Add the bounded [AcyclicGuardedExceptions-v1](ACYCLIC-GUARDED-EXCEPTIONS-V1.md) fragment with its own schemas, fixtures and proof-neutral vectors. Typed facts and guarded penalties are later, separate extensions. Broaden to representative corpus strata only after small cases pass.
