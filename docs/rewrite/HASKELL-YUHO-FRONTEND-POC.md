...
The Haskell implementation does not yet accept v0.2 exact-version modules, imports or locks; v0.3 temporal expressions; v0.4 multi-fragment execution plans; penalty selection or terms authoring; registries; arbitrary expressions; fact or evidence extraction; temporal-law selection; or judicial outcomes. The Python implementations of those later synthetic subsets remain historical conformance references only. The existing legal-source and qualified-review limitations of the section 84 research prototype remain as documented; compilation is not a legal-fidelity finding.
