...
| `propositions` | Named `leaf`, `all` and `any` declarations referring to named propositions | Build one acyclic, source-ordered technical requirement tree. |
